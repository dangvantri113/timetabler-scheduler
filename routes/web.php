...
use App\Http\Controllers\Admin\SubjectLevelController;
...
Route::get('/admin/subject-level',[SubjectLevelController::class,'list']);
Route::post('/admin/subject-level/add',[SubjectLevelController::class,'add']);
Route::post('/admin/subject-level/edit',[SubjectLevelController::class,'edit']);
Route::post('/admin/subject-level/delete',[SubjectLevelController::class,'delete']);
...
Route::get('/admin/random',[TimeTableController::class,'random']);
